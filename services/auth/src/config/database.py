"""
Database configuration settings for auth service.
"""
...
class DatabaseSettings(BaseModel):
    ...
    postgres_user: str = Field("auth_admin", alias="POSTGRES_USER")
    postgres_password: str = Field("auth_secret", alias="POSTGRES_PASSWORD")
    postgres_server: str = Field("localhost", alias="POSTGRES_SERVER")
    postgres_port: int = Field(5432, alias="POSTGRES_PORT")
    postgres_db: str = Field("lorelounge_auth", alias="POSTGRES_DB")
