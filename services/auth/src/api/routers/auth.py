...
from domain.services.security import ACCESS_TOKEN_COOKIE_KEY, REFRESH_TOKEN_COOKIE_KEY
...
async def get_jwks():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Error generating security keys")
