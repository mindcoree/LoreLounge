...
class DatabaseSettings(BaseModel):
    ...
    postgres_user: str = Field("content_admin", alias="POSTGRES_USER")
    postgres_password: str = Field("content_secret", alias="POSTGRES_PASSWORD")
    postgres_server: str = Field("localhost", alias="POSTGRES_SERVER")
    postgres_port: int = Field(5432, alias="POSTGRES_PORT")
    postgres_db: str = Field("lorelounge_content", alias="POSTGRES_DB")
