"""
Конфигурация Alembic для auth-service (async mode с asyncpg).

Запуск из папки services/authentication/:
...
# Файл лежит в: services/authentication/alembic/env.py
# src/ лежит в: services/authentication/src/
SERVICE_DIR = Path(__file__).parent.parent          # services/authentication/
...
# из services/authentication/ — поэтому грузим явно.
