...
class AuthEntity(Base, TimestampMix):
    ...
    role: Mapped[Role] = mapped_column(
        SAEnum(Role, name="role_enum", create_type=True),
        nullable=False,
        default=Role.READER,
...
class RoleRequest(Base, TimestampMix):
    ...
    requested_role: Mapped[DesiredRole] = mapped_column(
        SAEnum(DesiredRole, name="desired_role_enum", create_type=True),
        nullable=False,
    )
    status: Mapped[RoleRequestStatus] = mapped_column(
        SAEnum(RoleRequestStatus, name="role_request_status_enum", create_type=True),
        nullable=False,
