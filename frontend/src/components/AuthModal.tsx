...
export default function AuthModal({ isOpen, onClose }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#121212] w-full max-w-md sm:max-w-md rounded-[32px] p-6 sm:p-8 border border-white/5 shadow-2xl">
        <button onClick={onClose} className="absolute right-4 top-4 sm:right-6 sm:top-6 text-gray-400 hover:text-white">
          <X size={20} />
        </button>

        {mode === "forgot" ? (
          <form onSubmit={handleSubmit} className="space-y-6">
            <h2 className="text-2xl font-bold text-center text-white mt-2">Забыли пароль?</h2>
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-[#1e1e1e] border border-white/5 rounded-full py-2.5 sm:py-2.5 sm:py-3 pl-10 sm:pl-12 pr-4 text-white focus:border-blue-500 outline-none transition-all"
              />
            </div>
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-[#3b82f6] hover:bg-[#2563eb] text-white py-2.5 sm:py-3 rounded-full font-bold transition-all disabled:opacity-50"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <span className="bg-[#121212] px-4 text-gray-500 text-xs uppercase">или</span>
              <div className="border-t border-white/5 w-full"></div>
            </div>

            <div className="grid grid-cols-3 gap-3">
              <button type="button" className="flex justify-center items-center py-2.5 sm:py-3 bg-[#1e1e1e] hover:bg-[#2a2a2a] rounded-full transition-colors text-gray-400">
            ...
            <button type="button" className="w-full bg-[#0077FF] hover:bg-[#0066DD] text-white py-2.5 sm:py-3 rounded-full font-bold flex items-center justify-center gap-2 transition-all">
